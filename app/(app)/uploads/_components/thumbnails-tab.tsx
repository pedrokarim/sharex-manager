...
import { UPLOAD_CONFIG_LIMITS, UploadConfig } from "@/schemas/upload-config";
                  ...
                  <FormItem className="rounded-xl border border-border/60 bg-muted/20 p-4">
                    ...
                    <FormControl>
                      <BoundedNumberControl
                        ...
                        step={UPLOAD_CONFIG_LIMITS.thumbnailDimensionPx.step}
                        unit="px"
                        ariaLabel={t("uploads.config.thumbnails.max_width")}
                      />
                    </FormControl>
                  </FormItem>
                )}
                  ...
                  <FormItem className="rounded-xl border border-border/60 bg-muted/20 p-4">
                    ...
                    <FormControl>
                      <BoundedNumberControl
                        ...
                        step={UPLOAD_CONFIG_LIMITS.thumbnailDimensionPx.step}
                        unit="px"
                        ariaLabel={t("uploads.config.thumbnails.max_height")}
                      />
                    </FormControl>
                  </FormItem>
                )}
                  ...
                  <FormItem className="rounded-xl border border-border/60 bg-muted/20 p-4">
                    ...
                    <FormControl>
                      <BoundedNumberControl
                        ...
                        step={UPLOAD_CONFIG_LIMITS.thumbnailQuality.step}
                        unit="%"
                        ariaLabel={t("uploads.config.thumbnails.quality")}
                      />
                    </FormControl>
                  </FormItem>
                )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="space-y-4 rounded-xl border border-border/60 bg-muted/20 p-4">
                ...
                <p className="text-xs text-muted-foreground sm:text-sm">
                  Vérifiez le rendu du flou avant de l&apos;appliquer à toute
                  la galerie.
                </p>
              </div>
                ...
                <div className="space-y-3 rounded-xl border border-border/60 bg-background p-4">
                  ...
                  <FormControl>
                    <BoundedNumberControl
                      ...
                      step={UPLOAD_CONFIG_LIMITS.thumbnailBlurPx.step}
                      unit="px"
                      ariaLabel={t("uploads.config.thumbnails.blur_preview")}
                    />
                  </FormControl>
                </div>
