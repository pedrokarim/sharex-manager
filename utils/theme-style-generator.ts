...
const generateThemeVariables = (
  ...
  const spacingVar =
    mode === "light"
      ? `\n  --spacing: ${themeStyles["light"].spacing ?? defaultThemeState.styles.light.spacing};`
      : "";

  const trackingVars =
    mode === "light"
      ? `\n  --tracking-normal: ${themeStyles["light"]["letter-spacing"] ?? defaultThemeState.styles.light["letter-spacing"]};`
      : "";
