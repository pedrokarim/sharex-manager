...
const ResponsiveDialogContentVariants = cva("fixed z-[9999] bg-background", {
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      direction: "left",
      className:
        "bottom-2 left-2 top-2 flex w-[min(310px,calc(100vw-1rem))] bg-transparent outline-none [--initial-transform:calc(100%+8px)]",
    },
    {
      device: "mobile",
      direction: "right",
      className:
        "bottom-2 right-2 top-2 w-[min(310px,calc(100vw-1rem))] bg-transparent outline-none [--initial-transform:calc(100%+8px)]",
    },
  ],
});
