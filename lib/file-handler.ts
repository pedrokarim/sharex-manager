...
export async function serveFile({
  ...
  try {
    ...
    if (!stats.isFile()) {
      ...
      return fallbackPath ? await serveFallbackFile(fallbackPath) : new Response("Not found", { status: 404 });
    }
    ...
    return fallbackPath ? await serveFallbackFile(fallbackPath) : new Response("File not found", { status: 404 });
  }
}
