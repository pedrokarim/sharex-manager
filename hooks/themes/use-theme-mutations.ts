...
export function useCreateTheme() {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success(`Theme "${data.name}" has been created successfully.`);
    },
    onError: (error) => {
      if (error.name === "ThemeLimitError") {
        toast.error(`You have reached the limit of ${MAX_FREE_THEMES} themes.`);
        openGetProDialog();
      } else {
...
export function useUpdateTheme() {
  ...
  return useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast.success(`Theme "${data.name}" has been updated successfully.`);
    },
...
export function useDeleteTheme() {
  ...
  return useMutation({
    ...
    onSuccess: (data, themeId) => {
      ...
      toast.success(`Theme "${data.name}" has been deleted successfully.`);
      router.refresh();
    },
